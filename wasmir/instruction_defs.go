...
func init() {
	instructionDefs = append(instructionDefs, extraInstructionDefs()...)
...
// extraInstructionDefs returns catalog entries for instructions that are
// handled through handwritten binary and/or validation paths but still benefit
// from centralized text syntax and lowering metadata.
func extraInstructionDefs() []InstructionDef {
