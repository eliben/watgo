...
func init() {
	...
	registerInstructions(instrSyntaxPlain, map[string]wasmir.InstrKind{
		...
		"v128.any_true":                 wasmir.InstrV128AnyTrue,
		"v128.not":                      wasmir.InstrV128Not,
		"v128.and":                      wasmir.InstrV128And,
		"v128.andnot":                   wasmir.InstrV128AndNot,
		"v128.or":                       wasmir.InstrV128Or,
		"v128.xor":                      wasmir.InstrV128Xor,
		"i8x16.swizzle":                 wasmir.InstrI8x16Swizzle,
		"i8x16.all_true":                wasmir.InstrI8x16AllTrue,
		"i8x16.bitmask":                 wasmir.InstrI8x16Bitmask,
		"i8x16.narrow_i16x8_s":          wasmir.InstrI8x16NarrowI16x8S,
		"i8x16.narrow_i16x8_u":          wasmir.InstrI8x16NarrowI16x8U,
		"i8x16.shl":                     wasmir.InstrI8x16Shl,
		"i8x16.shr_s":                   wasmir.InstrI8x16ShrS,
		"i8x16.shr_u":                   wasmir.InstrI8x16ShrU,
		"i16x8.eq":                      wasmir.InstrI16x8Eq,
		"i16x8.ne":                      wasmir.InstrI16x8Ne,
		"i16x8.lt_s":                    wasmir.InstrI16x8LtS,
		"i16x8.lt_u":                    wasmir.InstrI16x8LtU,
		"i16x8.gt_s":                    wasmir.InstrI16x8GtS,
		"i16x8.gt_u":                    wasmir.InstrI16x8GtU,
		"i16x8.le_s":                    wasmir.InstrI16x8LeS,
		"i16x8.le_u":                    wasmir.InstrI16x8LeU,
		"i16x8.ge_s":                    wasmir.InstrI16x8GeS,
		"i16x8.ge_u":                    wasmir.InstrI16x8GeU,
		"i16x8.extadd_pairwise_i8x16_s": wasmir.InstrI16x8ExtaddPairwiseI8x16S,
		"i16x8.extadd_pairwise_i8x16_u": wasmir.InstrI16x8ExtaddPairwiseI8x16U,
		"i16x8.abs":                     wasmir.InstrI16x8Abs,
		"i16x8.neg":                     wasmir.InstrI16x8Neg,
		"i16x8.q15mulr_sat_s":           wasmir.InstrI16x8Q15mulrSatS,
		"i16x8.all_true":                wasmir.InstrI16x8AllTrue,
		"i16x8.bitmask":                 wasmir.InstrI16x8Bitmask,
		"i16x8.narrow_i32x4_s":          wasmir.InstrI16x8NarrowI32x4S,
		"i16x8.narrow_i32x4_u":          wasmir.InstrI16x8NarrowI32x4U,
		"i16x8.extend_low_i8x16_s":      wasmir.InstrI16x8ExtendLowI8x16S,
		"i16x8.extend_low_i8x16_u":      wasmir.InstrI16x8ExtendLowI8x16U,
		"i16x8.shl":                     wasmir.InstrI16x8Shl,
		"i16x8.shr_s":                   wasmir.InstrI16x8ShrS,
		"i16x8.shr_u":                   wasmir.InstrI16x8ShrU,
		"i16x8.add":                     wasmir.InstrI16x8Add,
		"i16x8.add_sat_s":               wasmir.InstrI16x8AddSatS,
		"i16x8.add_sat_u":               wasmir.InstrI16x8AddSatU,
		"i16x8.sub":                     wasmir.InstrI16x8Sub,
		"i16x8.sub_sat_s":               wasmir.InstrI16x8SubSatS,
		"i16x8.sub_sat_u":               wasmir.InstrI16x8SubSatU,
		"i16x8.mul":                     wasmir.InstrI16x8Mul,
		"i16x8.min_s":                   wasmir.InstrI16x8MinS,
		"i16x8.min_u":                   wasmir.InstrI16x8MinU,
		"i16x8.max_s":                   wasmir.InstrI16x8MaxS,
		"i16x8.max_u":                   wasmir.InstrI16x8MaxU,
		"i16x8.avgr_u":                  wasmir.InstrI16x8AvgrU,
		"i16x8.extmul_low_i8x16_s":      wasmir.InstrI16x8ExtmulLowI8x16S,
		"i16x8.extmul_high_i8x16_s":     wasmir.InstrI16x8ExtmulHighI8x16S,
		"i16x8.extmul_low_i8x16_u":      wasmir.InstrI16x8ExtmulLowI8x16U,
		"i16x8.extmul_high_i8x16_u":     wasmir.InstrI16x8ExtmulHighI8x16U,
		"i32x4.splat":                   wasmir.InstrI32x4Splat,
		"i32x4.extract_lane":            wasmir.InstrI32x4ExtractLane,
		"i32x4.all_true":                wasmir.InstrI32x4AllTrue,
		"i32x4.bitmask":                 wasmir.InstrI32x4Bitmask,
		"i32x4.eq":                      wasmir.InstrI32x4Eq,
		"i32x4.lt_s":                    wasmir.InstrI32x4LtS,
		"i32x4.extend_low_i16x8_s":      wasmir.InstrI32x4ExtendLowI16x8S,
		"i32x4.extend_low_i16x8_u":      wasmir.InstrI32x4ExtendLowI16x8U,
		...
		"i32x4.sub":                     wasmir.InstrI32x4Sub,
		"i32x4.mul":                     wasmir.InstrI32x4Mul,
		"i32x4.neg":                     wasmir.InstrI32x4Neg,
		"i32x4.min_s":                   wasmir.InstrI32x4MinS,
		"i64x2.all_true":                wasmir.InstrI64x2AllTrue,
		"i64x2.bitmask":                 wasmir.InstrI64x2Bitmask,
		...
		"f32x4.eq":                      wasmir.InstrF32x4Eq,
		"f32x4.ne":                      wasmir.InstrF32x4Ne,
		"f32x4.lt":                      wasmir.InstrF32x4Lt,
		"f32x4.gt":                      wasmir.InstrF32x4Gt,
		"f32x4.le":                      wasmir.InstrF32x4Le,
		"f32x4.ge":                      wasmir.InstrF32x4Ge,
		"f32x4.ceil":                    wasmir.InstrF32x4Ceil,
		"f32x4.floor":                   wasmir.InstrF32x4Floor,
		"f32x4.trunc":                   wasmir.InstrF32x4Trunc,
		"f32x4.nearest":                 wasmir.InstrF32x4Nearest,
		"f32x4.abs":                     wasmir.InstrF32x4Abs,
		"f32x4.neg":                     wasmir.InstrF32x4Neg,
		"f32x4.sqrt":                    wasmir.InstrF32x4Sqrt,
		"f32x4.convert_i32x4_s":         wasmir.InstrF32x4ConvertI32x4S,
		"f32x4.convert_i32x4_u":         wasmir.InstrF32x4ConvertI32x4U,
		"f32x4.add":                     wasmir.InstrF32x4Add,
		"f32x4.sub":                     wasmir.InstrF32x4Sub,
		"f32x4.mul":                     wasmir.InstrF32x4Mul,
		"f32x4.div":                     wasmir.InstrF32x4Div,
		"f32x4.min":                     wasmir.InstrF32x4Min,
		"f32x4.max":                     wasmir.InstrF32x4Max,
		"f32x4.pmin":                    wasmir.InstrF32x4Pmin,
		"f32x4.pmax":                    wasmir.InstrF32x4Pmax,
		"f64x2.eq":                      wasmir.InstrF64x2Eq,
		"f64x2.ne":                      wasmir.InstrF64x2Ne,
		"f64x2.lt":                      wasmir.InstrF64x2Lt,
		"f64x2.gt":                      wasmir.InstrF64x2Gt,
		"f64x2.le":                      wasmir.InstrF64x2Le,
		"f64x2.ge":                      wasmir.InstrF64x2Ge,
		"f64x2.ceil":                    wasmir.InstrF64x2Ceil,
		"f64x2.floor":                   wasmir.InstrF64x2Floor,
		"f64x2.trunc":                   wasmir.InstrF64x2Trunc,
		"f64x2.nearest":                 wasmir.InstrF64x2Nearest,
		"f64x2.abs":                     wasmir.InstrF64x2Abs,
		"f64x2.neg":                     wasmir.InstrF64x2Neg,
		"f64x2.sqrt":                    wasmir.InstrF64x2Sqrt,
		"f64x2.add":                     wasmir.InstrF64x2Add,
		"f64x2.sub":                     wasmir.InstrF64x2Sub,
		"f64x2.mul":                     wasmir.InstrF64x2Mul,
		"f64x2.div":                     wasmir.InstrF64x2Div,
		"f64x2.min":                     wasmir.InstrF64x2Min,
		"f64x2.max":                     wasmir.InstrF64x2Max,
		"f64x2.pmin":                    wasmir.InstrF64x2Pmin,
		"f64x2.pmax":                    wasmir.InstrF64x2Pmax,
		"f64x2.convert_low_i32x4_s":     wasmir.InstrF64x2ConvertLowI32x4S,
		"f64x2.convert_low_i32x4_u":     wasmir.InstrF64x2ConvertLowI32x4U,
		"f32x4.demote_f64x2_zero":       wasmir.InstrF32x4DemoteF64x2Zero,
		"f64x2.promote_low_f32x4":       wasmir.InstrF64x2PromoteLowF32x4,
