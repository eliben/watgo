...
var instructionDefs = []InstructionDef{
	...
	directOp(InstrI32TruncF32S, "i32.trunc_f32_s", 0xa8, unarySig(ValueTypeF32, ValueTypeI32)),
	directOp(InstrI32TruncF32U, "i32.trunc_f32_u", 0xa9, unarySig(ValueTypeF32, ValueTypeI32)),
	directOp(InstrI32TruncF64S, "i32.trunc_f64_s", 0xaa, unarySig(ValueTypeF64, ValueTypeI32)),
	directOp(InstrI32TruncF64U, "i32.trunc_f64_u", 0xab, unarySig(ValueTypeF64, ValueTypeI32)),
	prefixedOp(InstrI32TruncSatF32S, "i32.trunc_sat_f32_s", 0xfc, 0x00, unarySig(ValueTypeF32, ValueTypeI32)),
	prefixedOp(InstrI32TruncSatF32U, "i32.trunc_sat_f32_u", 0xfc, 0x01, unarySig(ValueTypeF32, ValueTypeI32)),
	prefixedOp(InstrI32TruncSatF64S, "i32.trunc_sat_f64_s", 0xfc, 0x02, unarySig(ValueTypeF64, ValueTypeI32)),
	prefixedOp(InstrI32TruncSatF64U, "i32.trunc_sat_f64_u", 0xfc, 0x03, unarySig(ValueTypeF64, ValueTypeI32)),
	...
	directOp(InstrI64TruncF32S, "i64.trunc_f32_s", 0xae, unarySig(ValueTypeF32, ValueTypeI64)),
	directOp(InstrI64TruncF32U, "i64.trunc_f32_u", 0xaf, unarySig(ValueTypeF32, ValueTypeI64)),
	directOp(InstrI64TruncF64S, "i64.trunc_f64_s", 0xb0, unarySig(ValueTypeF64, ValueTypeI64)),
	directOp(InstrI64TruncF64U, "i64.trunc_f64_u", 0xb1, unarySig(ValueTypeF64, ValueTypeI64)),
	prefixedOp(InstrI64TruncSatF32S, "i64.trunc_sat_f32_s", 0xfc, 0x04, unarySig(ValueTypeF32, ValueTypeI64)),
	prefixedOp(InstrI64TruncSatF32U, "i64.trunc_sat_f32_u", 0xfc, 0x05, unarySig(ValueTypeF32, ValueTypeI64)),
	prefixedOp(InstrI64TruncSatF64S, "i64.trunc_sat_f64_s", 0xfc, 0x06, unarySig(ValueTypeF64, ValueTypeI64)),
	prefixedOp(InstrI64TruncSatF64U, "i64.trunc_sat_f64_u", 0xfc, 0x07, unarySig(ValueTypeF64, ValueTypeI64)),
	...
	directOp(InstrF32Le, "f32.le", 0x5f, binarySig(ValueTypeF32, ValueTypeF32, ValueTypeI32)),
	directOp(InstrF32Ge, "f32.ge", 0x60, binarySig(ValueTypeF32, ValueTypeF32, ValueTypeI32)),
	directOp(InstrF32Abs, "f32.abs", 0x8b, unarySig(ValueTypeF32, ValueTypeF32)),
	...
	directOp(InstrF32Copysign, "f32.copysign", 0x98, binarySig(ValueTypeF32, ValueTypeF32, ValueTypeF32)),
	...
	directOp(InstrF64Ne, "f64.ne", 0x62, binarySig(ValueTypeF64, ValueTypeF64, ValueTypeI32)),
	directOp(InstrF64Lt, "f64.lt", 0x63, binarySig(ValueTypeF64, ValueTypeF64, ValueTypeI32)),
	directOp(InstrF64Gt, "f64.gt", 0x64, binarySig(ValueTypeF64, ValueTypeF64, ValueTypeI32)),
	directOp(InstrF64Le, "f64.le", 0x65, binarySig(ValueTypeF64, ValueTypeF64, ValueTypeI32)),
	directOp(InstrF64Ge, "f64.ge", 0x66, binarySig(ValueTypeF64, ValueTypeF64, ValueTypeI32)),
	directOp(InstrF64Abs, "f64.abs", 0x99, unarySig(ValueTypeF64, ValueTypeF64)),
	...
	directOp(InstrF64Copysign, "f64.copysign", 0xa6, binarySig(ValueTypeF64, ValueTypeF64, ValueTypeF64)),
	...
	prefixedOp(InstrI8x16RelaxedSwizzle, "i8x16.relaxed_swizzle", 0xfd, 0x100, binarySig(ValueTypeV128, ValueTypeV128, ValueTypeV128)),
	...
	prefixedOp(InstrI16x8RelaxedDotI8x16I7x16S, "i16x8.relaxed_dot_i8x16_i7x16_s", 0xfd, 0x112, binarySig(ValueTypeV128, ValueTypeV128, ValueTypeV128)),
	...
	prefixedOp(InstrI32x4RelaxedTruncF32x4S, "i32x4.relaxed_trunc_f32x4_s", 0xfd, 0x101, unarySig(ValueTypeV128, ValueTypeV128)),
	prefixedOp(InstrI32x4RelaxedTruncF32x4U, "i32x4.relaxed_trunc_f32x4_u", 0xfd, 0x102, unarySig(ValueTypeV128, ValueTypeV128)),
	prefixedOp(InstrI32x4RelaxedTruncF64x2SZero, "i32x4.relaxed_trunc_f64x2_s_zero", 0xfd, 0x103, unarySig(ValueTypeV128, ValueTypeV128)),
	prefixedOp(InstrI32x4RelaxedTruncF64x2UZero, "i32x4.relaxed_trunc_f64x2_u_zero", 0xfd, 0x104, unarySig(ValueTypeV128, ValueTypeV128)),
	prefixedOp(InstrI32x4RelaxedLaneselect, "i32x4.relaxed_laneselect", 0xfd, 0x10b, ternarySig(ValueTypeV128, ValueTypeV128, ValueTypeV128, ValueTypeV128)),
	prefixedOp(InstrI32x4RelaxedDotI8x16I7x16AddS, "i32x4.relaxed_dot_i8x16_i7x16_add_s", 0xfd, 0x113, ternarySig(ValueTypeV128, ValueTypeV128, ValueTypeV128, ValueTypeV128)),
	...
	prefixedOp(InstrI64x2RelaxedLaneselect, "i64x2.relaxed_laneselect", 0xfd, 0x10c, ternarySig(ValueTypeV128, ValueTypeV128, ValueTypeV128, ValueTypeV128)),
	...
	prefixedOp(InstrF32x4RelaxedMadd, "f32x4.relaxed_madd", 0xfd, 0x105, ternarySig(ValueTypeV128, ValueTypeV128, ValueTypeV128, ValueTypeV128)),
	prefixedOp(InstrF32x4RelaxedNmadd, "f32x4.relaxed_nmadd", 0xfd, 0x106, ternarySig(ValueTypeV128, ValueTypeV128, ValueTypeV128, ValueTypeV128)),
	prefixedOp(InstrI8x16RelaxedLaneselect, "i8x16.relaxed_laneselect", 0xfd, 0x109, ternarySig(ValueTypeV128, ValueTypeV128, ValueTypeV128, ValueTypeV128)),
	prefixedOp(InstrF32x4RelaxedMin, "f32x4.relaxed_min", 0xfd, 0x10d, binarySig(ValueTypeV128, ValueTypeV128, ValueTypeV128)),
	prefixedOp(InstrF32x4RelaxedMax, "f32x4.relaxed_max", 0xfd, 0x10e, binarySig(ValueTypeV128, ValueTypeV128, ValueTypeV128)),
	...
	prefixedOp(InstrF64x2RelaxedMadd, "f64x2.relaxed_madd", 0xfd, 0x107, ternarySig(ValueTypeV128, ValueTypeV128, ValueTypeV128, ValueTypeV128)),
	prefixedOp(InstrF64x2RelaxedNmadd, "f64x2.relaxed_nmadd", 0xfd, 0x108, ternarySig(ValueTypeV128, ValueTypeV128, ValueTypeV128, ValueTypeV128)),
	prefixedOp(InstrI16x8RelaxedLaneselect, "i16x8.relaxed_laneselect", 0xfd, 0x10a, ternarySig(ValueTypeV128, ValueTypeV128, ValueTypeV128, ValueTypeV128)),
	prefixedOp(InstrF64x2RelaxedMin, "f64x2.relaxed_min", 0xfd, 0x10f, binarySig(ValueTypeV128, ValueTypeV128, ValueTypeV128)),
	prefixedOp(InstrF64x2RelaxedMax, "f64x2.relaxed_max", 0xfd, 0x110, binarySig(ValueTypeV128, ValueTypeV128, ValueTypeV128)),
